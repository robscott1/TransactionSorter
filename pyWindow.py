...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.importTab.setGeometry(QtCore.QRect(80, 60, 961, 641))
        ...
        self.openCatPopUp.setGeometry(QtCore.QRect(790, 480, 113, 32))
        ...
        self.deleteCategory.setGeometry(QtCore.QRect(640, 530, 113, 32))
        self.deleteCategory.setObjectName("deleteCategory")
        self.editCategory = QtWidgets.QPushButton(self.Categorize)
        self.editCategory.setGeometry(QtCore.QRect(500, 530, 111, 32))
        ...
        self.undoBtn.setGeometry(QtCore.QRect(790, 530, 111, 31))
        self.undoBtn.setObjectName("undoBtn")
        self.label_4 = QtWidgets.QLabel(self.Categorize)
        self.label_4.setGeometry(QtCore.QRect(500, 480, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.categoryAllotted = QtWidgets.QLabel(self.Categorize)
        self.categoryAllotted.setGeometry(QtCore.QRect(584, 480, 61, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_8.setGeometry(QtCore.QRect(650, 470, 71, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_8.setFont(font)
        self.label_8.setObjectName("label_8")
        self.categorySpent = QtWidgets.QLabel(self.Categorize)
        self.categorySpent.setGeometry(QtCore.QRect(720, 480, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
