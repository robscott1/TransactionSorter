...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.TabWidget.setGeometry(QtCore.QRect(60, 70, 961, 641))
        ...
        self.gridLayout.addWidget(self.importCsvBtn, 7, 0, 2, 1)
        ...
        self.gridLayout.addWidget(self.enterCSVLabel, 2, 0, 2, 1)
        self.gridLayout_2.addLayout(self.gridLayout, 0, 0, 1, 1)
        self.TabWidget.addTab(self.Import, "")
        ...
        self.plotWindow.setGeometry(QtCore.QRect(730, 470, 151, 51))
        ...
        self.checkingBalance = QtWidgets.QLineEdit(self.Projection)
        self.checkingBalance.setGeometry(QtCore.QRect(70, 70, 101, 22))
        self.checkingBalance.setObjectName("checkingBalance")
        self.label_7 = QtWidgets.QLabel(self.Projection)
        self.label_7.setGeometry(QtCore.QRect(190, 70, 161, 21))
        self.label_7.setObjectName("label_7")
        self.lineEdit = QtWidgets.QLineEdit(self.Projection)
        self.lineEdit.setGeometry(QtCore.QRect(70, 120, 101, 22))
        self.lineEdit.setObjectName("lineEdit")
        self.label_9 = QtWidgets.QLabel(self.Projection)
        self.label_9.setGeometry(QtCore.QRect(190, 120, 91, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.TabWidget.setTabText(self.TabWidget.indexOf(self.Import), _translate("MainWindow", "Import"))
        ...
        self.label_9.setText(_translate("MainWindow", "Monthly Income"))
